# 海風 SeaWind 網站設計文件
| 2026.05.11 | 海風網站助手 | **會員頁面全面重寫＋支持須知/贊助跳轉統一：①會員.html 從舊版單一方案重寫為 v2 設計系統三階會員方案（青 100 / 藍 200 / 紫 500）＋完整回饋對比表＋累計里程碑＋連續贊助加成＋推薦獎勵＋贊助流程＋注意事項＋6 則 FAQ；②支持須知.html 改為跳轉至會員.html；③贊助.html 跳轉目標改為會員。cache busting → 110511b。頁尾日期 → 2026.05.11 |
