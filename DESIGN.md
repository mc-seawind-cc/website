...
| 季卡 | **500 冷媒/季**（約 40-80 天），13 項便利功能（到期關閉，無會員稱號） |
...
| 2026.05.14 | 海風網站助手 | **會員方案定價重構＋贈卡系統定案**：①~~月費 200~~ → 永久買斷 800 冷媒（8 項永久擴充）＋季卡 500 冷媒/季（20 項體驗功能）；②贈卡 30 風汐錠，送朋友 7 天體驗型試用（不含永久擴充/稱號/支持牆/風汐加碼）；③回饋分類：永久型（數值調整，買斷留存）8 項＋體驗型（功能開關，到期關閉）20 項；④風汐商店概念清單 12→4（僅保留贈卡/多功能工具/季度稱號/季度物品）；⑤會員.html 全面更新——Hero/價格卡雙方案/回饋清單分永久+體驗/對比表三欄/FAQ 7 則；⑥贊助.md 全面重寫。cache busting → 140514a。頁尾日期 → 2026.05.14 |
