# 海風 SeaWind 網站設計文件
| 2026.05.11 | 海風網站助手 | **支持須知頁面全面重寫**：①從舊版 lore-block 升級至 v2 設計系統（guide-v2-hero + guide-section-card + guide-faq + guide-next-grid）；②新增「方案總覽」三階會員卡片（青 100 / 藍 200 / 紫 500 冷媒/月，以顏色區分等級）；③新增「完整回饋對比」表格（30+ 項回饋逐項對比：稱號/領地/傳送點/商店/隨地開/簽到/郵件/倉庫/權限/其他/紫專屬）；④新增「累計里程碑」5 張卡片（200→500→1000→2000→5000 冷媒，含稱號＋獎勵）；⑤新增「連續贊助加成」3 張卡片（3/6/12 個月，含風汐錠加成＋限定稱號）；⑥新增「推薦獎勵」區塊（推薦 1 人各 50 冷媒＋累計 3 人人脈王稱號）；⑦新增「贊助流程」3 步驟卡片；⑧注意事項改為 6 張卡片格子佈局；⑨新增 6 則 FAQ（回饋時間/升級降級/稱號期限/匯率/遊戲貨幣/推薦領取）；⑩新增 3 個相關頁面。贊助.html 跳轉頁精簡（移除多餘 footer）。cache busting → 110511a。頁尾日期 → 2026.05.11 |
...
| 2026.05.11 | 海風網站助手 | **支持須知頁面全面重寫**：v2 設計系統＋三階會員方案（青 100 / 藍 200 / 紫 500）＋完整回饋對比表＋累計里程碑＋連續贊助加成＋推薦獎勵＋贊助流程＋6 則 FAQ。cache busting → 110511a。頁尾日期 → 2026.05.11 |
| 2026.05.09 | 海風網站助手 | **新增公告 #0140（斷線重啟——修復幽靈玩家問題）**：announcements.json 490→491 則，首頁/公告頁 inline JSON 同步更新 |
| 2026.05.09 | 海風網站助手 | **領地系統頁面精簡**：①移除重複子領地區塊（合併為單一區塊）；②領地權限精簡為概覽+連結（詳細內容移至子頁面）；③領地列表精簡為概覽+連結；④常用指令 24→12 條；⑤FAQ 9→6 則；⑥移除「什麼是領地」視覺化圖表；⑦擴縮領地精簡為單行說明。806→600 行（-25%）。頁尾日期→2026.05.09 |
| 2026.05.09 | 海風網站助手 | **刪除舊跳轉頁面**：領地系統/權限列表.html、領地系統/領地列表.html（已由 權限.html、列表.html 取代） |
| 日期 | 修改者 | 修改內容 |
