...
> 最後更新：2026.05.13
> 以下為會員回饋系統的 redesign 方向，待確認後實作。

### 已確認的方向

| 項目 | 決定 | 狀態 |
|---|---|---|
| 每日冷媒 | 會員每日簽到 +2 冷媒（月回饋 60 冷媒＝30%） | ✅ 已確認 |
| 風汐錠產量 | 會員 2 顆/日（60/月）、非會員 1 顆/日（30/月） | ✅ 已確認 |
| 風汐商店 | 外觀 3 項＋功能 4 項＋贈卡 1 項＋工具包 2 項＋消耗品 2 項＝12 項商品 | ✅ 已確認 |
| 限定稱號 | 季度制（每季換一次），稱號綁定粒子效果。Q2「潮汐守望者」 | ✅ 已確認 |
| 贈卡 | 50 顆風汐錠，送朋友 7 天完整會員體驗 | ✅ 已確認 |
| 粒子效果 | 跟稱號綁定，不是獨立商品 | ⏳ 需插件研究 |
| 工具包 | 新手包 12 顆（鐵製工具＋食物）/ 礦工包 28 顆（鑽石工具＋鐵甲） | ✅ 已確認 |

### 參考遊戲機制

| 遊戲 | 機制 | 海風對應 |
|---|---|---|
| 原神·空月祝福 | 月卡 $5，每天領 90 原石×30 天 | 會員每日 +2 冷媒，30 天累積 60 冷媒 |
| 原神·珍珠紀行 | 免費/付費雙軌，做任務升級解鎖獎勵 | 月度進度階梯（目前做不出來，先跳過） |
| 光遇·季卡 | 限定外觀錯過不復刻、可贈送好友 | 季度限定稱號＋贈卡系統 |
| Fortnite·Crew | 月費綁定通行證＋每月獨佔造型 | 月度主題＋限定稱號 |
| MC 伺服器常見 | Donator rank、cosmetic perks | 已有基礎，擴充風汐商店 |
...
| 來源 | 每日 | 每月（30 天） | 說明 |
|---|---|---|---|
| 會員簽到 | 2 冷媒 + 2 顆風汐錠 | 60 冷媒 + 60 顆 | 冷媒＝月費回饋感；風汐錠＝商店貨幣 |
| 非會員簽到 | 1 顆風汐錠 | 30 顆 | 免費玩家也能慢慢買到好東西 |

> 設計原則：會員月累積 60 顆，非會員 30 顆。會員約 25 天可存到一張贈卡，非會員約 50 天。

#### 消耗：外觀類

| 商品 | 價格 | 說明 | 狀態 |
|---|---|---|---|
| 稱號顏色自訂 | 10 顆 | 自訂遊戲內稱號的顏色 | ✅ 已確認 |
| 季度限定稱號（含粒子） | 30 顆 | 過期的季度稱號可回購（見下方季度規劃） | ✅ 已確認 |
| 自訂加入訊息 | 25 顆 | 進入伺服器時顯示的歡迎文字（16 字元內） | ✅ 已確認 |

#### 消耗：功能類

| 商品 | 價格 | 說明 | 狀態 |
|---|---|---|---|
| 額外個人傳送點 ×1 | 15 顆 | 永久多一個傳送點額度 | ✅ 已確認 |
| 額外倉庫格 ×4 | 20 顆 | 永久多 4 格倉庫空間 | ✅ 已確認 |
| 領地改名卡 | 10 顆 | 更改領地顯示名稱 | ✅ 已確認 |
| 個人傳送點改名卡 | 5 顆 | 更改傳送點名稱 | ✅ 已確認 |

#### 消耗：贈卡與工具包

| 商品 | 價格 | 說明 | 狀態 |
|---|---|---|---|
| 贈卡（7 天體驗） | 50 顆 | 送給非會員朋友，7 天完整會員體驗。收禮者綁定帳號後自動生效 | ✅ 已確認 |
| 新手補給包 | 12 顆 | 鐵製全套工具（劍/鎬/斧/鏟/鋤）＋熟牛排 ×64＋火把 ×32 | ✅ 已確認 |
| 礦工裝備包 | 28 顆 | 鑽石鎬/劍/斧/鏟＋鐵甲全套（頭/胸/腿/靴）＋熟牛排 ×64 | ✅ 已確認 |

> 贈卡定價邏輯：7 天 ≈ 月費 25%，但風汐錠是免費取得的貨幣，定價 50 顆讓非會員約 50 天可存到、會員約 25 天可存到，作為「送朋友來玩」的動力。

#### 消耗：消耗品

| 商品 | 價格 | 說明 | 狀態 |
|---|---|---|---|
| 隨機傳送卷 | 3 顆 | 隨機傳送到主世界某個位置 | ✅ 已確認 |
| 領地回家卷 | 2 顆 | 立即傳送回主領地 | ✅ 已確認 |

> 移除「經驗加成」——海風強調「不肝、不焦慮」，經驗加成與此理念矛盾。
...
一個月累積 → 60 冷媒 + 60 風汐錠
                ...
                v
冷媒 → 會員月費回饋感（每天都有東西領）
風汐錠 → 風汐商店 → 贈卡(50)/工具包(12~28)/外觀(10~30)/消耗品(2~3)
```
...
| 季度 | 月份 | 主題 | 稱號 | 粒子效果 | 狀態 |
|---|---|---|---|---|---|
| Q2 2026 | 5-7 月 | 海洋/守護 | 潮汐守望者 | 海浪 + 泡泡 | ✅ 已確認 |
| Q3 2026 | 8-10 月 | 夏日/冒險 | 逐浪冒險家 | 陽光 + 沙粒 | ✅ 已確認 |
| Q4 2026 | 11-1 月 | 冬季/溫暖 | 極光旅人 | 雪花 + 極光 | ✅ 已確認 |
| Q1 2027 | 2-4 月 | 春天/新生 | 春風使者 | 花瓣 + 新芽 | ✅ 已確認 |

> 稱號設計原則：①四字成語感，有文學底蘊；②每季稱號＋粒子效果綁定，過期可回購；③粒子效果需插件配合（待技術確認）。

### 待辦清單

- [x] 確認每日冷媒數量 → **2**
- [x] 確認風汐錠每日產量 → **會員 2 / 非會員 1**
- [x] 確認風汐商店商品清單與定價 → **已完成**
- [x] 確認贈卡價格與內容 → **50 顆，7 天完整會員體驗**
- [x] 確認工具包內容 → **新手包 12 顆 / 礦工包 28 顆**
- [x] 取第一季稱號名字 → **潮汐守望者**
- [ ] 設計第一季粒子效果（需插件配合）
- [ ] 研究粒子效果與稱號綁定的技術可行性
- [ ] 更新會員頁面文案（加入風汐商店說明）
...
## 10. 修改記錄
| 2026.05.13 | 海風網站助手 | **風汐商店 v2 設計定稿**：①確認風汐錠每日產量——會員 2 顆/日（月 60 顆）、非會員 1 顆/日（月 30 顆）；②贈卡定價 50 顆（7 天完整會員體驗）；③工具包設計——新手補給包 12 顆（鐵製全套＋食物＋火把）、礦工裝備包 28 顆（鑽石工具＋鐵甲＋食物）；④季度稱號定稿——Q2 潮汐守望者（海浪＋泡泡）、Q3 逐浪冒險家（陽光＋沙粒）、Q4 極光旅人（雪花＋極光）、Q1 春風使者（花瓣＋新芽）；⑤移除經驗加成（違背「不肝」理念）；⑥商店商品總計 12 項（外觀 3＋功能 4＋贈卡 1＋工具包 2＋消耗品 2）；⑦DESIGN.md 8d 節「待辦」→「已確認」。頁尾日期 → 2026.05.13 |
