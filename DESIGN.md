...
## 10. 修改記錄
| 2026.05.13 | 海風網站助手 | **會員頁面重新設計（29 項回饋）**：①回饋清單全面更新——主領地 10+10→20+20（修正舊版 30+30）、交易上限對齊 10→15/120→250、郵件費用 1 風幣→免費；②新增 5 項回饋：自訂稱號、簽到自訂獎勵、會員名單展示、節日額外獎勵、活動額外獎勵；③回饋卡片 17→29 項；④對比表同步更新；⑤贊助流程「聯繫管理員」→「開啟線上工單」；⑥FAQ 新增「自訂稱號有什麼限制？」（7 則）；⑦相關頁面新增「線上工單」；⑧cache busting → 130513a。頁尾日期 → 2026.05.13 |
| 2026.05.12 | 海風網站助手 | **全站 cache busting 統一＋線上工單職位選單優化**：①style.css 版本從 `110511g` 統一更新至 `110511n`（54 頁）；②線上工單應徵職位下拉選單：「插件」→「插件開發」、「網頁」→「網頁設計」、「策劃」→「活動策劃」、「平衡」→「數值平衡」，更易理解。頁尾日期 → 2026.05.12 |
