...
| 2026.04.28 | 海風網站助手 | **端午節原料擴充至 10 種**：events repo items.yml 新增 5 種原料（魷魚 ID:12 / 滷花生 ID:13 / 台灣香菇 ID:14 / 金鉤蝦 ID:15 / 栗子 ID:16），五花肉→滷肉。recipes.yml 北部粽從工作台 3×3 改為 NPC 兌換面板（與南部粽統一），NPC 名稱統一為「木地人」，新增全部 6 項種植兌換配方。mobs.yml 掉落描述同步更新 |
