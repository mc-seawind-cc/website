# 海風 SeaWind 網站設計文件
| 2026.05.12 | 海風網站助手 | **線上工單展開卡片加寬**：①`.pd-body` 展開時 max-width 從 720px → 1000px（`transition` 平滑過渡）；②右欄 flex 從 1 → 1.3、max-width 從 600px → 650px，表單區域更寬敞。頁尾日期 → 2026.05.12 |
...
## 10. 修改記錄
| 2026.05.12 | 海風網站助手 | **線上工單展開卡片加寬**：pd-body 展開時 720→1000px、右欄 flex 1.3＋max-width 650px。頁尾日期 → 2026.05.12 |
