...
每日 10 個任務，依稀有度機率分配（普通 0.8 / 進階 0.5 / 稀有 0.3 / 史詩 0.1）。
高進度玩家的任務池中，高稀有度任務的比例更高。
...
| 91 | 熔岩行者 | 挖掘黑石 | ×16 |
| 91 | 熔岩行者 | 挖掘黑石 | ×16 |
| 92 | 上好翡翠9塊9上車 | 挖掘綠寶石礦 | ×3 |

**⚔️ 高級戰鬥**

| # | 任務名稱 | 目標 | 數量 |
|---|---|---|---|
| 93 | 周處除三害 | 殺死殭屍+骷髏+蜘蛛 | 各×5 |
| 94 | 別撿破爛 | 殺死拾荒者 | ×3 |
| 95 | 就你大隻 | 殺死鐵魔像 | ×1 |
| 96 | 魔法根源敗於武力 | 殺死女巫 | ×3 |
| 97 | 史萊姆全家桶 | 殺死史萊姆 | ×10 |
...
| 108 | 服裝設計師 | 合成皮革 | ×8 |
| 109 | 虧本生意 | 合成鑽石裝備 | ×1 |
| 110 | 下界合金碎片 | 挖掘 ancient debris | ×1 |
