# 海風 SeaWind 網站設計文件
| 2026.05.03 | 海風網站助手 | **領地系統指南重構**：①移除 Hero 快速統計「權限 114 種」和「傳送延遲 3 秒」；②全頁移除「114」數字引用（meta description、領地權限區塊、什麼是領地區塊、權限列表連結描述）改為不綁定數量的描述；③「每分子領地上限」修正為「每個主領地的子領地上限」（2 處）；④子領地說明新增「繼承父領地預設權限」；⑤「建立子領地」區塊合併至「建立領地」內（步驟完全一樣，改為 h3 子標題）；⑥「建立子領地」快捷方式 callout 保留。cache busting 不變（僅 HTML 內容修改） |
...
| 日期 | 修改者 | 修改內容 |
|---|---|---|
| 2026.05.03 | 海風網站助手 | **領地系統指南重構**：①移除 Hero 快速統計「權限 114 種」「傳送延遲 3 秒」；②全頁移除「114」數字引用改為不綁定數量的描述；③「每分子領地上限」→「每個主領地的子領地上限」；④子領地說明新增「繼承父領地預設權限」；⑤「建立子領地」合併至「建立領地」（h3 子標題） |
