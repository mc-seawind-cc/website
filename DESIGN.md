...
| 2026.04.23 | 海風網站助手 | **新增 Instagram 貼文素材**：製作兩篇貼文圖片（1080×1080 SVG→PNG）+ 文案檔案。① 基本資料貼文（`ig-post-info.png` + `IG-POST-基本資料.md`）：伺服器介紹、特色、社群規模。② 珍奶日活動貼文（`ig-post-bubbletea.png` + `IG-POST-珍奶日.md`）：活動日期、13 種口味、限定武器/稱號、時間軸。兩張圖均延續網站海洋風格深色設計 |
