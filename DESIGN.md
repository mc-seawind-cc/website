...
| 2026.04.28 | 海風網站助手 | **設計規範新增第三節「物品管理」**：規範特殊物品 ID 命名規則（前綴_序號、大寫英文、不可重複使用）、上線後限制（不得修改 ID 或刪除、替換需建新 ID）、活動專案記錄要求（代號 + MMOItems 配置）。原第三～七節重新編號為第四～八節。修訂日期更新至 115.04.28 |
