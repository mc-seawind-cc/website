# 海風 SeaWind 網站設計文件
| 2026.05.02 | 海風網站助手 | **簽到系統指南頁全面重寫**：根據 RewardSettings.yml 實際配置全面重寫——①每日獎勵表對齊配置（平日：風幣 180＋碎片×2；週末：風幣 200＋碎片×4＋金胡蘿蔔×32）；②新增連續簽到 6 階里程碑表（3 天附魔金蘋果→7 天獄髓錠→90 天連簽之星→360 天連簽之王→630 天連簽之子→900 天連簽之神）；③新增累積簽到 9 階蛋糕系列稱號表（180 天乳酪蛋糕～1440 天奶油蛋糕，含 1000 天 10,000 風幣大獎）；④新增簽到月曆介面說明（4 色方塊狀態表）；⑤新增補簽卡機制（實體物品、獎勵較少、無法獲得週末/特殊日期加碼）；⑥新增會員專屬加碼區塊（平日額外碎片×2＋風汐錠×2＋環保杯×3；週末額外碎片×4＋風汐錠×2＋環保杯×3＋風幣 200）；⑦新增深夜彩蛋區塊（23:00-23:59 虛弱 5 秒＋00:00-02:59 虛弱 15 秒，附送枯萎薔薇＋牛奶桶）；⑧指令擴充（/signin gui、/signin leaderboard、/signin info）；⑨FAQ 3→6 則；⑩移除舊版不準確的 30 天隨機獎勵表 |
