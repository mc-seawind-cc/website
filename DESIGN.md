# 海風 SeaWind 網站設計文件
| 2026.05.11 | 海風網站助手 | **會員頁面三階方案重新設計**：①打掉舊版單一方案，重寫為三階定價卡（微風 100 / 海風 200 / 嵐風 500 冷媒/月）；②海風方案（推薦）保留截圖原有全部回饋內容不變；③微風方案精簡（僅工作台+鐵砧隨地開啟、無自動簽到/郵件免費/顏色代碼/隱藏裝備/變更大小）；④嵐風方案在海風基礎上擴充（領地+40、傳送點60、商店400、倉庫48、專屬粒子效果、優先客服）；⑤完整回饋對比表 5 欄（預設/微風/海風/嵐風）＋嵐風專屬分類；⑥海洋主題浮動氣泡粒子動畫；⑦新增 FAQ「會員會影響遊戲平衡嗎？」＋「可以中途升級或降級嗎？」（7 則）；⑧Hero 區新增「不影響遊戲公平」提示。cache busting → 110511d。頁尾日期 → 2026.05.11 |
