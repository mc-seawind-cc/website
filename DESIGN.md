...
| 項目 | 決定 |
|---|---|
| 永久買斷 | **800 冷媒**，一次性解鎖 8 項永久擴充（領地/傳送點/商城/商店/倉庫） |
| 季卡 | **500 冷媒/季**（約 40-80 天），解鎖 20 項體驗功能 |
| 贈卡 | **30 風汐錠**，送朋友 7 天體驗型試用 |
...
- **永久型（8 項）**：數值調整，買斷留存。領地/傳送點/商城/商店/倉庫擴充
- **體驗型（20 項）**：功能開關，到期關閉。隨地開啟/簽到/稱號/榮譽標識
