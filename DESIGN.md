# 海風 SeaWind 網站設計文件
| 2026.05.14 | 海風網站助手 | **每日任務 125 個全面重新設計**：①新增 DESIGN.md 8f 節——每日任務設計方案（設計原則/任務目標類型/獎勵結構/完整 125 個任務清單/8 個冒險任務）；②任務按 6 大分類組織（基礎合成/挖礦採集/戰鬥/農牧漁/探索/進階合成等）；③每個任務有創意名稱＋目標類型＋數量；④網站任務頁「任務內容」區塊全面重寫——從部分名稱列表改為按稀有度＋分類的完整表格（普通 62/進階 33/稀有 20/史詩 10）；⑤FAQ 修正（五種→四種稀有度，移除贊助）；⑥待辦清單標記完成。cache busting → 140514l。頁尾日期 → 2026.05.14 |
| 2026.05.14 | 海風網站助手 | **任務系統指南頁全面重寫（新任務資料庫）**：①任務類型 4 種（每日/卷軸/冒險/社區）；②移除贊助任務（已不存在）；③每日任務 4 種稀有度（普通 2 幣＋100 風幣、進階 6 幣＋140、稀有 10 幣＋200、史詩 64 幣＋500 風幣）；④新增「任務內容」區塊——列出新資料庫 125 個每日任務＋8 個冒險任務的實際任務名稱（普通/進階/稀有/史詩各列舉代表性任務）；⑤冒險任務名稱列表（8 個）；⑥獎勵總覽表格同步更新（4 種稀有度）；⑦移除風汐旋和風汐石（非任務產出）；⑧FAQ 5 則（移除贊助任務 FAQ）；⑨小技巧更新（移除贊助任務提示＋新增任務名稱趣味提示）。cache busting → 140514k。頁尾日期 → 2026.05.14 |
...
任務難度依玩家遊玩程度遞進，不同等級的玩家會拿到不同難度的任務池：

| 等級 | 條件 | 任務特色 | 範例 |
|---|---|---|---|
| 🌱 新芽 | 加入 ~1 週 | 基礎操作，熟悉遊戲 | 砍樹、挖煤、殺殭屍 |
| 🌿 居民 | 1 週 ~ 1 個月 | 進階材料，開始探索 | 鐵裝備、繁殖動物、附魔 |
| 🌳 資深 | 1 個月 ~ 3 個月 | 稀有素材，高難度戰鬥 | 鑽石、地獄、Boss 級怪物 |
| 🏔️ 傳說 | 3 個月以上 | 終極挑戰，史詩目標 | 凋零、獄髓、大規模收集 |
