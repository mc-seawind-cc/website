# 海風 SeaWind 網站設計文件
| 2026.05.14 | 海風網站助手 | **任務系統指南頁全面重寫（新獎勵結構）**：①任務類型 4 種（保留卷軸任務——活動期間限定，如珍奶日/端午節）；②新增完整獎勵表——每日任務 5 種稀有度（普通 2 幣＋100 風幣、進階 6 幣＋140、稀有 10 幣＋200、史詩 64 風汐石＋500 風幣、贊助 2 幣＋20 風幣）、冒險任務（2 幣＋依任務風幣）、社區任務（10 社區資金＋10 社區活躍）；③新增「獎勵總覽」合併表格（含卷軸任務列）；④新增「任務相關貨幣」區塊（任務幣/風幣/風汐石三種）；⑤移除風汐旋（非任務產出）；⑥稀有度 6→5 級（普通/進階/稀有/史詩/贊助）；⑦FAQ 6 則（含贊助任務說明）；⑧相關頁面新增社區系統（4 張）。cache busting → 140514k。頁尾日期 → 2026.05.14 |
