...
| 稀有度 | config 名稱 | 顏色 | 任務幣 | 風幣 | 普通機率 | 居民機率 |
|---|---|---|---|---|---|---|
| ⚪ 普通 | normal | #FFFFFF | 2 | 100 | 70% | 35% |
| 🔵 進階 | advanced | #FFFF55 | 6 | 140 | 20% | 55% |
| 🟣 中階 | rare | #55FFFF | 10 | 200 | 8% | 8% |
| 🟠 高階 | rarer | #FF55FF | 64 | 500 | 2% | 2% |
| 🟢 冒險 | mythical | #4ab652 | 2 | 依各任務 | 0% | 0% |

> 設定檔中另有 `epic`（#a8e6cf）目前未啟用。
> 居民階段：進階 55%、普通 35%，更容易遇到高獎勵任務。
...
|---|---|---|---|
| 🌱 新芽 | ~1 週 | 普通 | normal |
| ☕ 常客 | 1 週~2 月 | 進階 + 一點中階 | + advanced + rare |
| 🌿 居民 | 2 月+ | 全部（按機率分配） | + rarer + mythical |
